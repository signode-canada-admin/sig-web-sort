...
try:
    print(premium_plus_process(json.loads(sys.argv[1]), sys.argv[2]))
except Exception as e: 
    print("error", repr(e))
# print({"success": True})

# premium_plus_process({"line_items":[{"quantity":"1","product":"428756"},{"quantity":"3","product":"428789"},{"quantity":"7","product":"428811"},{"quantity":"4","product":"428873"},{"quantity":"1","product":"428895"},{"quantity":"2","product":"428909"},{"quantity":"1","product":"428920"}],"ship_via":"PUROLATOR","po_no":"411369","num_line_items":7}, 'PP1')
sys.stdout.flush()